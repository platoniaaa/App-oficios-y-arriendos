        ...
        <div className="container-page relative grid items-center gap-10 py-14 md:grid-cols-12 md:py-24">
          <div className="md:col-span-7 space-y-7 animate-fade-up">
            ...
            <p className="max-w-xl text-lg text-ink-500 text-pretty">
              Encuentra al maestro justo o arrienda la máquina que necesitas sin vueltas. Paga al
              final, cuando el trabajo esté listo. El asistente IA arma la cuadrilla por ti.
            </p>
        ...
        <div className="container-page">
          ...
          <ol className="grid gap-6 md:grid-cols-4">
            {[
              ...
              { n: '03', t: 'Se ejecuta la pega', d: 'Chat directo con el maestro, documentos y visitas programadas.' },
          ...
          <div className="relative grid gap-8 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-4 text-ink-500 max-w-md">
                ...
                adecuadas y te arma una cotización en segundos.
              </p>
            ...
            <ul className="space-y-3">
              {[
                ...
                '"Pintar el exterior de una casa de dos pisos"',
              ].map((q) => (
                <li
                  key={q}
